...
export class Player {
  ...
  get radius(): number {
    return getPlayerRadiusFromScore(this.score);
  }
  ...
  public update(scene: Scene) {
    ...
    if (this.head.x < this.radius) this.head.x = this.radius;
    if (this.head.y < this.radius) this.head.y = this.radius;
    if (this.head.x > scene.width - this.radius)
      this.head.x = scene.width - this.radius;
    if (this.head.y > scene.height - this.radius)
      this.head.y = scene.height - this.radius;
